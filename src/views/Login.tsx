...
=======
            <p className="text-xl text-primary-container mb-12 max-w-2xl mx-auto">Join the elite tier of wealth management. Start tracking, budgeting, and growing your net worth today.</p>
>>>>>>> 25f7ca01d67337a303beda77836dd67669acca07
            <button 
              onClick={() => { setIsLogin(false); setShowLanding(false); }}
